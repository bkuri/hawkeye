...
'use strict';
var APP, App, CONFIG_TEMPLATE, INOTIFY_LIB, Inotify, MiniLog, TOKEN, VERSION, app, args, deploy, fs, inotify, log, minimatch;
...
App = (function() {
  App.createConfig = function(file) {
    return fs.writeFile(file, JSON.stringify(CONFIG_TEMPLATE, function(error) {
      if (error) {
        log.error(error);
      } else {
